...
def validate(val_loader, model, criterion_seg, criterion_classify):
    avg_meters = {'loss_seg': AverageMeter(),
...
for epoch in range(1, 16):
    ...
    val_log = validate(val_loader, net, criterion_seg, criterion_classify)
...
for epoch in range(1, 16):
    ...
    train_log = train_classify(init_train_loader, net, criterion_classify, optimizer_classify)
    val_log = validate(val_loader, net, criterion_seg, criterion_classify)
...
for rd in range(1, NUM_ROUND+1):
    ...
    for epoch in range(1, 21):
        ...
        train_log = train_classify(train_loader, net, criterion_classify, optimizer_classify)
        val_log = validate(val_loader, net, criterion_seg, criterion_classify)
